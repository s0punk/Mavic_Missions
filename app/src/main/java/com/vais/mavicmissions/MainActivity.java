...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnTest:
                Toast.makeText(this, "Tentative de vol vers l'avant...", Toast.LENGTH_SHORT).show();

                AircraftController controller = new AircraftController(MavicMissionApp.getAircraftInstance());
